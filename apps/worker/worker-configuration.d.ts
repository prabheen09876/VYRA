/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0fec729483364246a98d214346e7583b)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	AI_ENABLED: "false";
	CORS_ORIGINS: "http://localhost:8081,http://localhost:8082,http://localhost:19006,http://localhost:5173";
	MATCHES: DurableObjectNamespace<import("./src/index").MatchRoom>;
	PROFILES: DurableObjectNamespace<import("./src/index").ProfileCoordinator>;
	MATCHMAKING: DurableObjectNamespace<import("./src/index").Matchmaking>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MatchRoom" | "ProfileCoordinator" | "Matchmaking";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_ENABLED" | "CORS_ORIGINS">> {}
}
