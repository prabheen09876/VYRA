...
const styles = StyleSheet.create({
  ...
  codeLabel: { color: colors.muted, fontFamily: fonts.body, fontSize: 12, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1.6 }, code: { color: colors.text, fontFamily: fonts.display, fontWeight: '900', fontSize: 43, letterSpacing: 7 },
